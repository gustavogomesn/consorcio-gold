...
function NewLoan() {
    ...
    // each member can take a 3x loan, based on value of your stocks, soon i need to migrate this logic to 192.168.1.115
    ...
    return (
    <>
        <button onClick={() => setIsOpen(true)} className='btn btn-primary' >Novo Empréstimo</button>
